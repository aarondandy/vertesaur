...
{
    public class SpheroidEquatorialFFacts
    {

        [Fact]
        public void constructor() {
            var obj = new SpheroidEquatorialF(3.0, 4.0);
            Assert.Equal(3.0, obj.A);
            Assert.Equal(4.0, obj.F);

            obj = new SpheroidEquatorialF(4.0, 5.0);
            Assert.Equal(4.0, obj.A);
            Assert.Equal(5.0, obj.F);
        }
        ...
        public void property_b() {
            var obj = new SpheroidEquatorialF(3.0, 1.0 / 4.0);
