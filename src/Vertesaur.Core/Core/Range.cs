...
namespace Vertesaur
{
        ...
        IHasDistance<Range, double>, IHasDistance<double, double>
    {
        ...
        /// </summary>
        /// <param name="a">A range from the left argument.</param>
        /// <param name="b">A range from the right argument.</param>
        ...
        public double Mid {
            [Pure] get {
                Contract.Ensures(Low <= Contract.Result<double>());
                Contract.Ensures(Contract.Result<double>() <= High);
                return (Low + High) / 2.0;
            }
        }
        ...
        [Pure]
        public bool Intersects(double a, double b) {
            return (a <= b)
                ? (Low <= b) && (a <= High)
                : (Low <= a) && (b <= High);
        }
        ...
        [Pure]
        public bool Overlaps(double value) {
            return (Low == value && High == value)
        ...
        /// <inheritdoc/>
        [Pure]
        public bool SpatiallyEqual(double other) {
            return Equals(other);
        }
        ...
        [Pure]
        public Range Encompass(double value) {
        ...
        /// <returns>A range.</returns>
        [Pure]
        public Range Encompass(Range range) {
